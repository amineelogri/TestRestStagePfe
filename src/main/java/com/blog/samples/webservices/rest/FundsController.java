...
public class FundsController {
	 ...
	 * @return the fund
	 */
	@RequestMapping(value = "/rest/produits/{fundId}", method = RequestMethod.GET)
	 ...
	 * @return the funds
	 */
	@RequestMapping(value = "/rest/produits/", method = RequestMethod.GET)
	public ModelAndView getFunds() {
		List<Produit> funds = null;
	...
	public ModelAndView createFund(@RequestBody Produit fund_p,
		...
		httpResponse_p.setHeader("Location", request_p.getContextPath() + "/rest/funds/" + fund_p.getId());
	...
	public ModelAndView updateFund(@RequestBody Produit fund_p, @PathVariable("fundId") String fundId_p,
